...
from DL_toolbox.models.architecture_blocks import UpSample, DownSample, DenseBlock


class generator_dense_1x64x64(nn.Module):
    """Generator model"""
    ...
    def __init__(self, z_dim=50, cnn_init_dim=(512, 4, 4), act_param=0.1):
        ...
        """
        super(generator_dense_1x64x64, self).__init__()
...
class critic_dense_1x64x64(nn.Module):
    ...
    def __init__(self, init_dim=(1, 64, 64), init_k=16, act_param=0.1):
        ...
        x_shape does not include the number of samples N.
        """
        super(critic_dense_1x64x64, self).__init__()
